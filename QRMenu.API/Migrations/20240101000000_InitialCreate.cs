    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Meze ve salatalar", true, "Başlangıçlar", 1 },
                    { 2, "Sıcak yemekler", true, "Ana Yemekler", 2 },
                    { 3, "Soğuk ve sıcak içecekler", true, "İçecekler", 3 },
                    { 4, "Tatlı çeşitleri", true, "Tatlılar", 4 }
                });

            migrationBuilder.InsertData(
                table: "Tables",
                columns: new[] { "Id", "Description", "IsActive", "QRCodePath", "TableNumber" },
                values: new object[,]
                {
                    { 1, "Pencere kenarı", true, "", "1" },
                    { 2, "Bahçe", true, "", "2" },
                    { 3, "İç mekan", true, "", "3" }
                });
